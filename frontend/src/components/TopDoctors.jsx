  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <p className="sm:w-1/3 text-center text-sm text-gray-500">
        Simply browse through our extensive list of top doctors and book your
        appointment.
      </p>
      ...
      <button
        ...
        className="bg-blue-100 font-light text-sm text-gray-600 rounded-full py-3 px-5 cursor-pointer"
      >
        More
      </button>
    </div>
